...
const GoogleMeetUI = () => {
  ...
  return (
    <div className="google-meet-container position-fixed w-100 h-100 ">
      {cameraError && (
      ...
      <div className="main-content d-flex ">
        <div className='m-0 p-0 d-flex video-main-view-p   w-100 position-relative'>
          <div className="meeting-info d-flex align-items-center d-lg-none d-inline-block position-absolute top-0 start-0">
      ...
      <div className="control-bar bg-dark text-light d-flex justify-content-between align-items-center py-2 px-3">
        <div className="meeting-info d-flex align-items-center d-lg-inline-flex d-none">
          <span className="meeting-code">
            <i className="bi bi-shield-lock me-2"></i>
            <strong>{courseId}</strong>
          </span>
